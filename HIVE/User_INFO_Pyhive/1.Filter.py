...
usr_log = pd.read_csv("CpuLogData2019-10-24.csv")
...
Cpulog_data = pd.DataFrame(users_new_data)
Cpulog_data = Cpulog_data.T
Cpulog_data.index.name = "user_name"
Cpulog_data.reset_index(inplace=True)
Cpulog_data.to_csv("usrINFO.csv", index=False)
print(Cpulog_data.to_csv("usrINFO.csv", index=False))
print (Cpulog_data)